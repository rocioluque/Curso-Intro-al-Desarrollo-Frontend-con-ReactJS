...
function agregarTarea() {
    ...
    if (nuevaTareaTexto !== "") {
        ...
        const botonMarcarCompletada = document.createElement("button");
        botonMarcarCompletada.textContent = "Completada";
        botonMarcarCompletada.className = "success";
        botonMarcarCompletada.onclick = function () {
            marcarCompletada(nuevaTarea);
        };

        nuevaTarea.appendChild(botonMarcarCompletada);
